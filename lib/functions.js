...
module.exports = {
  ...
  kakaoPush: async (up, cn) => {
    let message = '';
    let template_code = '';
    let user_phone = up;
    let confirm_number = cn;
    template_code = 'smsauth';
    message = `[HOLD] 인증번호\n[ ${confirm_number} ]`;
    let data = {
      plusFriendId: '@Zoomin',
    ...
    var url = '/alimtalk/v2/services/ncp:kkobizmsg:kr:2613702:stkypic/messages'; // url (include query string)
    ...
    await axios({
      url:
        'https://sens.apigw.ntruss.com/alimtalk/v2/services/ncp:kkobizmsg:kr:2613702:stkypic/messages',
