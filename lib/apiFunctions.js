...
module.exports = {
  ...
  findMembers: async (whereData) => {
    ...
    const findResult = result.map((data) => {
      ...
      data.templateId = data.config.idx;
  ...
  sendCompanyAlarm: async (
    ...
    try {
      findMembers.forEach(async (data) => {
        ...
        alarm.alarmId = createResult.idx;
        alarm.repeat_time = createResult.repeat_time;
        alarm.message = createResult.message;
        alarm.createdAt = createResult.createdAt;
        alarm.alarm_type = createResult.alarm_type;
        alarm.confirm = createResult.confirm;
