...
class Form {
  ...
  createCustomerData(address, phoneNumeber, formLinkCompany) {
    this.bodyData.searchingAddress = address;
    this.bodyData.searchingPhoneNumber = phoneNumeber;
    this.bodyData.company_idx = formLinkCompany.company_idx;
  ...
  fileStoreData(
    ...
    this.bodyData.customer_idx = searchingPhoneNumber;
    return this.bodyData;
  }
