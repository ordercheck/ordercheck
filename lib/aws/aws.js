    ...
    const form2Upload = multer({
      storage: multerS3({
        ...
        key(req, file, cb) {
          cb(
            null,
            `form2/${new Date().valueOf() + path.extname(file.originalname)}`
          );
        },
      }),
    });
    ...
    const thumbNailUpload = multer({
      storage: multerS3({
        ...
        key(req, file, cb) {
          ...
          cb(
            null,
            `original/${new Date().valueOf() + path.extname(file.originalname)}`
          );
        },
      }),
    });
    ...
    const thumbNailUpload = multer({
      storage: multerS3({
        ...
        key(req, file, cb) {
          cb(
            null,
            `formLink/${new Date().valueOf() + path.extname(file.originalname)}`
          );
        },
      }),
    });
